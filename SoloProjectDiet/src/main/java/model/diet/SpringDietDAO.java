...
public class SpringDietDAO {
	...
	// mysql insert구문
	private static String sql_INSERT = "INSERT INTO DIET (DNUM,BREAKFAST,LUNCH,DINER,ANOTHER,BREAKFASTCALORIE,LUNCHCALORIE,DINERCALORIE,ANOTHERCALORIE,DAYCALORIE,DDATE,D_USER) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
