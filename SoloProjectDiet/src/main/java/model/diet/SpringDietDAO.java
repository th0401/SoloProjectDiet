...
public class SpringDietDAO {
	...
	// mysql insert구문
	private static String sql_INSERT = "INSERT INTO diet (BREAKFAST,LUNCH,DINER,ANOTHER,BREAKFASTCALORIE,LUNCHCALORIE,DINERCALORIE,ANOTHERCALORIE,DAYCALORIE,DDATE,D_USER) VALUES(?,?,?,?,?,?,?,?,?,?,?)";
